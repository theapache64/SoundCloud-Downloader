...
public class ServerAPIResponse {
    ...
    private ServerAPIResponse(final boolean hasError, final int errorCode, final String message, final JSONObject joData) {
    ...
    public ServerAPIResponse(final String message, final JSONObject joData) {
        this(false, ERROR_CODE_NO_ERROR, message, joData);
    }

    public ServerAPIResponse(final String message, final String key, final String value) throws JSONException {
        this(false, ERROR_CODE_NO_ERROR, message, new JSONObject().put(key, value));
    }

    public ServerAPIResponse(final int errorCode, final String errorMessage) {
        this(true, errorCode, errorMessage, null);
    }

    public ServerAPIResponse(final String errorMessage) {
